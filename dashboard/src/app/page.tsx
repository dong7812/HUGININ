      ...
      <section className="pt-28 sm:pt-36 pb-0 px-5 sm:px-6 text-center bg-white overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="inline-flex items-center gap-2 bg-neutral-100 rounded-full px-4 py-1.5 mb-8 sm:mb-10">
            ...
            <span className="text-xs text-neutral-600 font-medium">Claude · agy · codex 지원 · 문서 임포트 · 무료</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {[
              ...
              },
              {
                title: "컨텍스트 추출",
                sub: "3단계 상세도",
                desc: "전체 의사결정 히스토리를 Markdown으로 다운로드. 새 AI 세션에 컨텍스트로 붙여넣거나 팀 온보딩 문서로 활용한다.",
                soon: false,
              },
              {
                title: "AI 기여도 측정",
      ...
      <section className="py-20 sm:py-28 px-5 sm:px-6 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-neutral-500 mb-12 text-sm sm:text-base max-w-xl mx-auto leading-relaxed break-keep">
            ...
            단, 기존 ADR·README는 <span className="font-mono text-neutral-700">huginin import</span>로 소급 복구할 수 있다.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
            {[
              { period: "설치 직후", value: "과거 문서 복구", desc: "huginin import로 기존 ADR·README를 구조화해 임베딩" },
              { period: "3개월 후", value: "프로젝트 지식베이스", desc: "커밋 + 문서 결정이 쌓여 왜 이런 구조가 됐는지 역추적 가능" },
